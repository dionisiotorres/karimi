...

{
    ...
    'depends': ['base','l10n_in_hr_payroll','hr_contract','report_xlsx','hr_payroll','hr_holidays','hr_attendance','sale_timesheet','hr_recruitment','hr_recruitment_survey','hr_expense','school','resource','bi_mustroll_excel','bi_sqlconnector','dev_employee_profile','hr_public_holidays','oh_employee_documents_expiry','mail','hr_payroll_account','contacts'],
    'data': [
            'security/security_view.xml',
            'views/employee_history.xml',
            'views/payslip_view.xml',
            'views/employee_request_form_view.xml',
